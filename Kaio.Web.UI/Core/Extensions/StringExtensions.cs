...
namespace Kaio.Core.Extensions
{
    public static class StringExtensions
    {
       ...
       /* public static string ToAbsoluteUrl(this string relativeUrl, Uri rootUrl)
        ...
        public static string ToAbsoluteUrl(this string relativeUrl, Uri websiteUrl)
        {
        ...
        {
            if (string.IsNullOrWhiteSpace(_unicodeText) || string.IsNullOrEmpty(_unicodeText)) return "";
        ...
        public static string HtmlToPlainText(this string html)
        {
            ...
            return reg.Replace(html, string.Empty).RemoveLineBreaks().Trim();
        }
